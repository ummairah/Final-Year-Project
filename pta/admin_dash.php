                ...
                <div class="payment-card light-red">
                    <div class="card--header">
                        <div class="amount">
                            <br>
                            <span class="title">
                                <a href="booking.php?id=<?php echo $_SESSION['idadmin']; ?>" style="text-decoration: none; color: black;">Completed Booking</a>
                            </span>
                ...
                <div class="payment-card light-purple">
                    ...
                    <div class="card--header">
                        <div class="amount">
                            <br>
                            <span class="title">
                            <a href="booking.php?id=<?php echo $_SESSION['idadmin']; ?>" style="text-decoration: none; color: black;">Pending Booking</a>
                            </span>
                            <span class="amount-value">
                                <?php
                ...
                <div class="payment-card light-green">
                    <div class="card--header">
                        <div class="amount">
                            <br>
                            <span class="title">
                            <a href="admin_complain.php?id=<?php echo $_SESSION['idadmin']; ?>" style="text-decoration: none; color: black;">Customer Complain</a>
                            </span>
                            <span class="amount-value">
                            <?php
